...
<link rel="stylesheet" href="{{asset('admin_asset/vendor/linearicons/style.css')}}">
<link rel="stylesheet" href="{{asset('admin_asset/vendor/chartist/css/chartist-custom.css')}}">
<!-- MAIN CSS -->
...
<link rel="icon" type="image/png" sizes="96x96" href="{{asset('admin_asset/img/favicon.png')}}">